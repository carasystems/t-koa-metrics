...
class LogScheduler {
  constructor(intervalDelay, logger) {
    ...
    process.on('SIGINT', this.shutdown.bind(this, { exit: true }));
    process.on('SIGUSR1', this.shutdown.bind(this, { exit: true }));
    process.on('SIGUSR2', this.shutdown.bind(this, { exit: true }));
  }
